...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of MMPhotoLibrary.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Moosa Mir/MMPhotoLibrary'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Moosa Mir' => 'moosamir68@gmail.com' }
  s.source           = { :git => 'https://github.com/Moosa Mir/MMPhotoLibrary.git', :tag => s.version.to_s }
